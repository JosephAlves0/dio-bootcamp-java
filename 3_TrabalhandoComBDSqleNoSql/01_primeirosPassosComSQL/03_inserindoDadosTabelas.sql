...
insert into employee values('Franklin','T','Wong',333445555,'1955-12-08','638-Voss-Houston-TX','M',40000,123456789,5),
							('Alicia','J','Zelaya',999887777,'1955-01-19','3321-Castle-Spring-TX','M',25000,333445555,4),
                            ('Jennifer','S','Wallace',987654321,'1941-06-20','291-Berry-Bellaire-TX','M',43000,null,4),
                            ('Ramesh','K','Narayan',666884444,'1962-09-15','975-Fire-Oak-Humble-TX','M',38000,987654321,5),
                            ('Joyce','A','English',453453453,'1972-07-31','5631-Rice-Houston-TX','M',25000,987654321,5),
                            ('Ahmad','V','Jabbar',987987987,'1969-03-29','980-Daçças-Houston-TX','M',25000,123456789,4),
...
insert into departament values('Research', 5, 333445555, '1988-05-22', '1986-05-22'),
							  ('Administration', 4, 987654321, '1995-01-21', '1994-01-01'),
...
select Fname, Dependent_name, Relationship from employee, dependent where Essn = Ssn;
 ...
 -- recuperando funcionário específico
